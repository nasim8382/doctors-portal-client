...
const Info = () => {
    return (
        <div className='mt-24 grid grid-cols-1 lg:grid-cols-3 gap-5'>
            ...
            <InfoCard cardTitle="Visit our location" cardText="Brooklyn, NY 10036, United States" img={marker} bgClass="bg-[#3A4256]"></InfoCard>
